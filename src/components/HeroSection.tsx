        ...
        <div className="mx-auto max-w-2xl flex-shrink-0 lg:mx-0 lg:max-w-xl pt-8">
          ...
          <div className="mt-10 flex items-center gap-x-6">
            <Link href="/users/login">
              <span className="rounded-md bg-blue-600 px-10 py-2.5 text-base font-semibold text-white shadow-sm hover:bg-blue-400 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-400">
                Get started
              </span>
            </Link>
          </div>
